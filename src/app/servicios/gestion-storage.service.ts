...
export class GestionStorageService {
  ...
  // Almacena una cadena de caracteres. Para cada string se necesita un
  // identificador (key) y su valor (value) Mediante await se indica que es un
  // método asíncrono que devuelve una promesa
  async setString(key: string, value: string) {
    await Storage.set({key, value});
  }

  // A partir de su clave identificadora (key) obtiene el valor de una cadena de
  // caracteres almacenada en local
  ...
  // Dada su clave, elimina un elemento almacenado en local independientemente
  // de su tipo
